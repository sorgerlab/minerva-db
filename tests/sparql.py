...
#
#     def test_create_users(self, client, users):
#         client.update(statements.create_user(**users))
#         # client.update(statements.create_user('bill', 'Big Bill',
#         #                                    'bill@example.com'))
#
#     def test_create_group(self, client, group_somelab):
#         client.update(statements.create_group(**group_somelab))
#
#     def test_add_user_to_group(self, client, group_somelab, user_bob, user_bill):
#         client.update(statements.add_users_to_group(group_somelab['uuid'],
#                                                   [user_bob['uuid'],
#                                                    user_bill['uuid']]))
#
#     def test_user_in_group(self, client, prefix, group_somelab, user_bob,
#                            user_bill):
#         expected = (
#             ['user', 'name'],
#             [
#                 {'user': 'https://cognito-idp.us-east-1.amazonaws.com/us-east-1_d9h9zgWpx#' + user_bob['uuid'], 'name': user_bob['name']},
#                 {'user': 'https://cognito-idp.us-east-1.amazonaws.com/us-east-1_d9h9zgWpx#' + user_bill['uuid'], 'name': user_bill['name']}
#             ]
#         )
